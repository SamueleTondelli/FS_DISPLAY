...
void initializeDataThermalPressure(DataThermalPressure* dataThermalPressure) {
	...
	initializeData(&(dataThermalPressure->oilTemperature), EMPTY_VALUE, OIL_TEMPERATURE_CONVERSION_FACTOR, OIL_TEMPERATURE_ALARM_PRIORITY, OIL_TEMPERATURE_MAX_VALUE, EMPTY_VALUE);
	...
	initializeData(&(dataThermalPressure->fuelTemperature), EMPTY_VALUE, FUEL_TEMPERATURE_CONVERSION_FACTOR, FUEL_TEMPERATURE_ALARM_PRIORITY, FUEL_TEMPERATURE_MAX_VALUE, EMPTY_VALUE);
	initializeData(&(dataThermalPressure->airTemperature), EMPTY_VALUE, AIR_TEMPERATURE_CONVERSION_FACTOR, AIR_TEMPERATURE_ALARM_PRIORITY, AIR_TEMPERATURE_MAX_VALUE, EMPTY_VALUE);
	initializeData(&(dataThermalPressure->waterTemperature), EMPTY_VALUE, WATER_TEMPERATURE_CONVERSION_FACTOR, WATER_TEMPERATURE_ALARM_PRIORITY, WATER_TEMPERATURE_MAX_VALUE, EMPTY_VALUE);
}
